...
Based on the original dataset,  different size of the dataset has been created to test different algorithms' performance on different size of the data. As a consequent, the best approach for small dataset and large dataset will be discussed. 
\section{Result}
